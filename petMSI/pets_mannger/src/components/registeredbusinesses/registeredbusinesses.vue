     ...
     <div class="title">
      ...
      <div class="forms">
        ...
        <div class="switchover">
              <el-button type="success" @click="jump">管理员注册</el-button>
                <el-button type="danger" :disabled="!status">商家注册</el-button>
        </div>
          <!-- 账号框 -->
          <div class="package">
         <label for="zhang">账号 : </label>   
          ...
          <label for="shou">手机号 : </label>  
           ...
           <div  class="signbutton">
                 <el-button type="primary" round  @click="affirm({a:'shops'})">确认注册</el-button>
           </div>
...
const {mapMutations,mapState,mapActions} = createNamespacedHelpers("register")
    export default {
        props:["title","status"],
         ...
         methods:{
         ...mapMutations(["switchstate","verifyaccoun","verifypassword","confirmpassword","verifyphone"]),
...
<style scoped>
        .entirety{
            ...
            background-image: url("../../assets/48f449deaeee92f4ff1cf3f258dd0e2e.png");
            background-size: 100%;
            overflow: hidden;
        }
        .title{
